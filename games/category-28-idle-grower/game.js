(() => {
  ...
  function starText(star) {
    ...
    return `<span class="star-tier"><span class="tier-num">${n}성</span><span class="tier-stars"><span class="fill">${"★".repeat(filled)}</span><span class="empty">${"☆".repeat(empty)}</span></span></span>`;
  }
