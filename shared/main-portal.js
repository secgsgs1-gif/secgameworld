import { logOut } from "./auth.js?v=20260224e";
import { claimDailyCheckIn, watchUserProfile } from "./points.js?v=20260224e";
...
function mountUI(user) {
  ...
  checkInBtn.onclick = async () => {
    ...
    try {
      const result = await claimDailyCheckIn(user.uid, 100);
      messageEl.textContent = result.granted ? "출석 완료: +100 포인트" : "오늘은 이미 출석 완료";
    } catch (e) {
